...
__display-message info ("Test: unknown control mode" | str upcase)
...
__display-message successful_step "Test: unknown control mode"

__line-separator

__display-message info ("Test: valid command in debug mode" | str upcase)
...
__display-message successful_step "Test: valid command in debug mode"

__line-separator

__display-message info ("Test: not valid command in debug mode" | str upcase)
...
__display-message successful_step "Test: not valid command in debug mode"

__line-separator

__display-message info ("Test: not valid command" | str upcase)
...
__display-message successful_step "Test: not valid command"

__line-separator

__display-message info ("Test: valid command" | str upcase)
...
__display-message successful_step "Test: valid command"
