...
__display-message info ("Test: load setting file" | str upcase)
...
__display-message successful_step "Test: load setting file"

__line-separator

__display-message info ("Test: load setting file with empty table" | str upcase)
...
__display-message successful_step "Test: load setting file with empty table"

__line-separator

__display-message info ("Test: load setting file with data in table" | str upcase)
...
__display-message successful_step "Test: load setting file with data in table"
